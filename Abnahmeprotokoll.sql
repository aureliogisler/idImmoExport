...
text_8202.tk_text AS kategorieMapped,
text_8051.tk_text AS detailMapped,
0 AS mengeMapped,
text_8052.tk_text AS materialMapped,
'' AS abnutzungMapped,
...
CONCAT('1', 
	...
	CONCAT(SUBSTR(CONCAT('000', NVL(remove_letters(utab3.levelNumber), '999')), -3), 
...
'' AS material,
'' AS abnutzung,
ausstattung.beschrieb AS shortDesignation
...
LEFT JOIN text_8202 ON text_8202.tk = ausstattung.tk_ausstgrp 
LEFT JOIN text_8051 ON text_8051.tk = ausstattung.tk_ausstbez 
LEFT JOIN text_8052 ON text_8052.tk = ausstattung.tk_ausstkat 
LEFT OUTER JOIN (
	SELECT 
...
) utab3 ON utab3.immobiliennr = obj.immobiliennr AND utab3.gebstmnr = obj.gebstmnr AND utab3.stwstmnr = obj.stwstmnr 
LEFT OUTER JOIN (
	SELECT 
	obj.immobiliennr,
	obj.gebstmnr,
